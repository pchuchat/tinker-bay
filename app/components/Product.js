...
export default function Product({product}) {
    ...
    return(
        ...
        <>
            ...
            className="max-w-[200px] p-15 border border-gray-50 hover:border-gray-200 hover:shadow-xl bg-gray-100 rounded mx-auto"
            >
            ...
            <div className="pt-2 px-1">
                ...
                <div className="font-extrabold">€{((product?.price*1.2) / 100).toFixed(2)}</div>

                <div className=" relative flex items-center text-[12px] text-gray-500">
                     <div className="line-throught">€{((product?.price*1.2) / 100).toFixed(2)}</div>
